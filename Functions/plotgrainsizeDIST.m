...
% set c limit in fractional weight% (0 to 1)
...
% distribution line will take full layer height
...
% set vertical reference ('top' or 'base')
...
% Display grainsize in mm instead of phi (default)
