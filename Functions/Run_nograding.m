...
fname='GS_California_PillarPoint_PPW-02.csv'; 
% Site Name
sname='Pillar Point';
...
% NO GRADING - irregular sampling intervals
grading = 0; 
...
for i=1:length(param)
    ...
    if grading ~= 0
        ...
        % no grading calculated
        n_intervals = 0;
        mean_RSE(i) = nan;
        root_square_error = nan;
    end
...
fig_dist = figure('name',['Plot: Image with stats: ' sname '_' SedSize.Tname]); 
hold on;
...
if length(SedSize.Sample_ID)>1 && grading ~= 0
