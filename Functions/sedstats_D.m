...
function [m1,stdev,m3,m4,fwmedian,fwmean,fwsort,fwskew,fwkurt]=sedstatsD(phi,weight)

% sedstatsD.m-  a function compute moment measures and Folk and Ward statistics from 
%                 sediment grain size weight % and phi size classes.
%
%   Minor change- uncommented cumultive weight percents to print to screen
%   (BJ- 8/28/12)
%
